...
{
    public class DereferencingListUpdator
    {
        ...
        public DereferencingListUpdator(MonoBehaviour asyncUtils, NetworkList<NetworkBehaviourReference> references)
        {
